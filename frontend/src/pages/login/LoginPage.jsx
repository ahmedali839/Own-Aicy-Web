...
//     return (
//         <div className='mt-[3vw] flex justify-center text-black'>
//             {/* <div className='mt-[3vw] flex justify-center text-orange-500'> */}

//             {/* <div className='m-5 p-10 border border-gray-800 rounded-xl md:w-[50%] '> */}
//             <div className='m-5 p-10 border border-orange-200 rounded-xl md:w-[50%] '>
...
//                         <div className='flex flex-col '>
//                             {/* <button type="submit" disabled={isSubmitting} className='font-bold bg-gray-700 w-full outline-none p-2 rounded-lg cursor-pointer hover:bg-gray-600'>{isSubmitting ? "Loggin in..." : "Continue"}</button> */}
//                             <button type="submit" disabled={isSubmitting} className='font-bold bg-orange-500 w-full outline-none p-2 rounded-lg text-white cursor-pointer hover:bg-orange-600'>{isSubmitting ? "Loggin in..." : "Continue"}</button>
//                         </div>
...
//                         <span className='mx-1 text-gray-300 text-sm'>Or continue with</span>
//                         <p className='flex-grow border-t border-gray-700'></p>
//                     </div>

//                     <div className='flex mt-5 gap-10'>
//                         <button className='w-1/2 p-2 text-center bg-transparent border border-gray-800 outline-none rounded-md hover:bg-gray-900'>Google</button>
//                         <button className='w-1/2 p-2 text-center bg-transparent border border-gray-800 outline-none rounded-md hover:bg-gray-900'>Github</button>
//                     </div>
